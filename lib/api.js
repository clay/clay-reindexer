 ...
 */
function reindex(uriStream, elasticIndex, {parallel = 1, transforms} = {}) {
  return uriStream
    .tap(i => console.log(i))
 ...
 */
function reindexPages(uriStream, elasticIndex, {limit, parallel, handlers, transforms, batch = 100} = {}) {
  return uriStream
