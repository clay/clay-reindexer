 ...
 * @returns {Stream}
 */
function addSiteSlug(doc) {
  // get the prefix from the uri here b/c option prefix may be an ip
  const prefix = doc.uri.split('/pages/')[0];
 ...
 * @param  {string} prefix
 * @param  {Object} handlers Mapping cmpt names to handler fncs
