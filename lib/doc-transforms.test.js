  ...
  describe(filename, function () {
    describe('applyHandlers', function () {
      ...
      it ('applies handlers if there is a matching component', function () {
        ...
        return fn(mockDoc, {prefix: mockPrefix, handlers: mockHandlers})
          .toPromise(Promise)
          .then((result) => {
      ...
      it ('exposes opts to handlers', function () {
        const mockHandlers = {
    ...
    describe('addSiteSlug', function () {
      ...
      it ('adds site slug', function () {
        util.getSite.withArgs('http://foo.com')
